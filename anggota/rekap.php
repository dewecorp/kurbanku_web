...
<section class="space-y-6" id="tab-rekap">
  <div class="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs flex flex-col">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-5 shrink-0">
      <div>
        <h3 class="text-sm font-bold text-slate-900 flex items-center gap-2"><i class="w-4.5 h-4.5 text-emerald-600" data-lucide="table-properties"></i><span>Rekap Setoran Saya</span></h3>
        <p class="text-[10px] text-slate-400 mt-1">Riwayat pembayaran tabungan per bulan pertemuan.</p>
      </div>
      <div class="flex flex-wrap items-center gap-2">
        ...
        <button class="px-3 py-2 border border-slate-200 hover:border-slate-300 text-slate-600 text-xs font-semibold rounded-xl flex items-center gap-1.5 transition bg-white" onclick="printRekapReport()"><i class="w-3.5 h-3.5" data-lucide="printer"></i> Cetak Rekap</button>
      </div>
    </div>
